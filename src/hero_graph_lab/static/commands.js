(() => {
  ...
  register({ id: "view.toggle-context", label: "Toggle graph context", shortcut: "C", description: "Show only active nodes or restore the full dimmed context", isEnabled: () => !document.querySelector("#context-visibility").disabled, execute: toggleContextVisibility });

    ...
    def test_serves_graph_and_persists_feedback(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            try:
                ...
                view_group = index.index('id="graph-tools-view"')
                ...
                self.assertLess(index.index('id="delete-node"'), view_group)
                self.assertLess(view_group, draft_group)
                self.assertLess(draft_group, index.index('id="sync-design"'))
                self.assertLess(index.index('id="reset-design"'), index.index('class="design-legend"'))
